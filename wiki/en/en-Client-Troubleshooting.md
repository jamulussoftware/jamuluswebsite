...
If you are using an USB-microphone, try to connect it directly to an USB-port in your computer, bypassing any USB-hub. Some USB-hubs have caused the error message "Your sound card is not working correctly. Please open the settings dialog and check the device selection and the driver settings.".
