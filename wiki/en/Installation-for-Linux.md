...
PipeWire provides a compatibility layer that emulates the JACK server. When you launch the Jamulus Client, PîpeWire presents itself to Jamulus as a JACK server.
