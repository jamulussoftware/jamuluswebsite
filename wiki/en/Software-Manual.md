...
**Ping** shows your network latency in milliseconds, the lower the better. Ping time contributes to overall delay (see below). The most probable causes for a high ping are that your distance to the server is too large or your internet connection is not sufficient.   
