...
Note that muting your **own** channel only means you will not hear your signal from the server (and is not advised as it can lead to you becoming out of time with other players). This is not the same as using "[Mute Myself](#mute-myself-button)".
...
If you set an instrument and/or country, icons for these selections will also be shown below your fader. The skill setting changes the background colour of the fader tag. If you hover your mouse over the fader tag, you'll also see the city:
