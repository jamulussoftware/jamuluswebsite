...
On Linux, use the JACK configuration tool to change the buffer size or, if using PipeWire's JACK server, change PipeWire's Quantum parameter with its own configuration tools.
