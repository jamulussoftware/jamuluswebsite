...
1. **Double-click the `.dmg` file** to open it. Agree to the license. It will then unpack and you will see two files (Jamulus client and server).
...
To open Jamulus, navigate to the Applications folder via Finder double-click on Jamulus, wait for the mentioned message, close this message by clicking on "Cancel", then control-click (or right-click) on Jamulus, and select "Open" from the top of the menu.
