...
1. **Extract the downloaded .zip file.** Double-click on the .zip file, which will create a new folder with same name. The folder contains the license file and a `.dmg` file containing the application.
