...
To open Jamulus, navigate to the Applications folder via Finder double-click on Jamulus, wait for the mentioned message, close this message, then right-click (or control-click), and select "Open" from the top of the menu.
